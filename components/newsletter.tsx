  ...
  return (
    <div className="relative text-center px-4 py-6 group">
      <div
        ...
        aria-hidden="true"
      />
      <div className="font-nycd text-xl text-indigo-500 mb-1">Help the best specialists find their dream job</div>
      <div className="text-2xl font-bold mb-5">Get in touch, if you can be a referrer</div>
